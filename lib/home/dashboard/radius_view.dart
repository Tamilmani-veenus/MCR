...
import 'package:mcr/home/dashboard/text_form_field.dart';
...
class _RadiusViewState extends State<RadiusView> {
  ...
  Future determinePosition() async {
    ...
    //   setState(() {
    //     loading = false;
    //     siteLocationController.punchInAddress = "${place.name}, ${place.thoroughfare}, ${place.subLocality}, ${place.locality},  ${place.administrativeArea}, ${place.postalCode}, ${place.country}.";
    //     siteLocationController.latitude = position.latitude.toString();
    //     siteLocationController.longitude = position.longitude.toString();
    //     if (kDebugMode) {
    //       print("Punch In Address :: ${siteLocationController.punchInAddress}");
    //     }
    //     if (kDebugMode) {
    //       print("Punch In latitude :: ${siteLocationController.latitude}");
    //     }
    //     if (kDebugMode) {
    //       print("Punch In longitude :: ${siteLocationController.longitude}");
    //     }
    //   });
    // }
