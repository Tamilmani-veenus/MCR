...
class _InwardReportState extends State<InwardReport> {
  ...
  void initState() {
    ...
    Future.delayed(duration, () async {
      ...
      suppliercontroller.getSupplierListData.value.clear();
      siteController.siteDropdownName.clear();

      await reportsController.getProjectReportList(context);
      await reportsController.getSupplierReportList(context);
  ...
  download(int uid,String uType,int pId,int sId,String pName, String sName,int supId, String supName,String fdate,String todate){
