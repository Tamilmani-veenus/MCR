...
import 'package:mcr/app_theme/app_colors.dart';
  ...
  Future determinePosition() async {
    ...
    try {
      ...
      final response = await http.get(url, headers: {
        "User-Agent": "skconstructions/1.0 (https://skconstructions.in/contact)"
      });
    ...
    try {
      ...
      if (status.isGranted) {
        ...
        final XFile? pickedFile = await picker.pickImage(
          ...
          maxWidth: 1280, // ✅ Resize to avoid huge memory usage
          maxHeight: 720,
          imageQuality: 80, // ✅ Compress image (0-100)
        );
        ...
        if (pickedFile != null) {
          ...
          // ✅ Save safely in app directory
          final savedFile = await File(pickedFile.path).copy('${appDir.path}/$fileName');

          setState(() {
            punchInController.punchOutImageFile.value =  XFile(savedFile.path);
      ...
      printToLog("Error taking picture: $e");
      BaseUtitiles.showToast("Something went wrong while capturing the image");
    }
  }
      ...
      child: Scaffold(
        ...
        body: SizedBox(
          ...
          child: apiLoading == "false"
            ...
            child: SingleChildScrollView(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  SizedBox(height: BaseUtitiles.getheightofPercentage(context, 6)),
                  Text(
                    "Tomorrow Plan",
                    style: TextStyle(
                      color: Colors.black,
                  ...
                  //   ],
                  // ):SizedBox(),
                  SizedBox(height: BaseUtitiles.getheightofPercentage(context, 15)),
                  Padding(
                          ...
                          if (punchInController.punchOutImageFile != null) {
                            ...
                            // }
                              ...
                              if (await BaseUtitiles.checkNetworkAndShowLoader(context)) {
                                await punchInController.punchOut(context);
                              }}
                          }
                          else {
            ...
            children: [
              const Text(
                "Please capture you photo for punch out",
                style: TextStyle(
                  fontSize: 12.0,
                  color: Colors.black,
                ),
              ...
              Column(
                children: [
                  if (punchInController.punchOutImageFile.value != null)
                    Expanded(
                      flex: 3,
                      child: Padding(
