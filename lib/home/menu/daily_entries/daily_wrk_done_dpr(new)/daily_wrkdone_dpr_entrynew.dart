                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              onTap: () {
                                if(dailyWrkDone_DPRNEW_Controller.editcheck == 2){
            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(
                  flex: 1,
                  child: Container(
                    child: Text("Units",style: TextStyle(fontSize: RequestConstant.App_Font_SIZE, fontWeight: FontWeight.bold, color: Theme.of(context).primaryColor),),
                  ),
                ),
                Expanded(
                  flex: 1,
                ...
                Expanded(
                  flex: 1,
                  child: Container(
                    child: Text("Current Qty",style: TextStyle(fontSize: RequestConstant.App_Font_SIZE,fontWeight: FontWeight.bold, color: Theme.of(context).primaryColor),),
                  ),
                ),
              ],
            ),
