                        ...
                        return TextButton(
                          onPressed:  () async {
                            ...
                            if (dailyWrkDone_DPRNEW_Controller.dprNew_EntryDetReadList.value[0].balQty != 0) {
                              if (dailyWrkDone_DPRNEW_Controller.dprNew_EntryDetReadList.value[0].balQty! <=
                                  dailyWrkDone_DPRNEW_Controller.AddQty) {
                                ...
                                // Check if button is in a non-processing state
                                  await dailyWrkDone_DPRNEW_Controller.getMesurmentTablesDatas();
      ...
      await dailyWrkDone_DPRNEW_Controller.SaveButton_dprNew_MSR_SaveAPI(
          context, dailyWrkDone_DPRNEW_Controller.saveId);
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              color: dailyWrkDone_DPRNEW_Controller.buttonControl == 0
                                  ? Theme.of(context).primaryColor
