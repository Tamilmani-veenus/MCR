...
class _Subcont_NMR_EntryListScreenState_Site
  ...
  void initState() {
    ...
    billGenerationDirectController.EntrylistFrDate.text =
    ...
    billGenerationDirectController.bill_entryList.value =
        billGenerationDirectController.main_entryList.value;
    super.initState();
  }
            ...
            child: Container(
              ...
              child: Obx(
                () => ListView.builder(
                    ...
                    physics: BouncingScrollPhysics(),
                    itemCount: billGenerationDirectController
                        .bill_entryList.value.length,
                                    ...
                                    Expanded(
                                        ...
                                        child: IconButton(
                                            onPressed: () {
                                              ...
                                              } else if (billGenerationDirectController
                                                          .bill_entryList
                                                          .value[index]
                                                          .appStatus ==
                                                      "Y" ||
