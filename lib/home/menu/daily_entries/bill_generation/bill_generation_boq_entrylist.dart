                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        flex: 8,
                                        child: Text(
                                          billGenerationBoqController.bill_entryList.value[index].project.toString(),
                                          style: TextStyle(
                                            color: Colors.black,),
                                        )),
                                  ],
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        flex: 8,
                                        child: Text(
                                          billGenerationBoqController.bill_entryList.value[index].subconName.toString(),
                                          style: TextStyle(
                                            color: Colors.black,
                                          ),
                                        )),
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        flex: 8,
                                        child: Text(
                                          billGenerationBoqController.bill_entryList.value[index].fdate.toString(),
                                          style: TextStyle(
                                            color: Colors.black,
                                          ),
                                        )),
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        flex: 8,
                                        child: Text(
                                          billGenerationBoqController.bill_entryList.value[index].tdate.toString(),
                                          style: TextStyle(
                                            color: Colors.black,),
                                        )),
                                  ],
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        flex: 8,
                                        child: Text(
                                          billGenerationBoqController.bill_entryList.value[index].preparedByName.toString(),
                                          style: TextStyle(color: Colors.black),
                                        )),
                                  ],
                                ),
