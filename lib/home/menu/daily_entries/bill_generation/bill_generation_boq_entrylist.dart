...
class _Bill_Generation_Boq_EntrylistState_Site
  ...
  void initState() {
    ...
    billGenerationBoqController.EntrylistFrDate.text =
    ...
    billGenerationBoqController.BillGenBoq_EntryList();
    super.initState();
  }
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              readOnly: true,
                              controller:
                                  billGenerationBoqController.EntrylistFrDate,
                              ...
                              onTap: () async {
                                billGenerationBoqController.bill_entryList
                                    .clear();
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              readOnly: true,
                              controller:
                                  billGenerationBoqController.EntrylistToDate,
                              cursorColor: Colors.black,
                              style: TextStyle(color: Colors.black),
                              decoration: InputDecoration(
                                contentPadding: EdgeInsets.zero,
            ...
            child: Container(
              ...
              child: Obx(
                () => ListView.builder(
                    ...
                    physics: BouncingScrollPhysics(),
                    itemCount:
                        billGenerationBoqController.bill_entryList.value.length,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        billGenerationBoqController
                                            .bill_entryList.value[index].workNo
                                            .toString(),
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold),
                                      ),
                                    ...
                                    Expanded(
                                        ...
                                        child: Text(
                                          billGenerationBoqController
                                              ...
                                              .toString(),
                                          style: TextStyle(
                                              color: billGenerationBoqController
                                                          .bill_entryList
                                                          .value[index]
                                                          .status ==
                                                      "Approved"
                                            ...
                                            onPressed: () {
                                              if (billGenerationBoqController
                                                ...
                                                BaseUtitiles.showToast(
                                                    "Verified record cannot be edited or deleted");
                                              } else if (billGenerationBoqController
                                                          .bill_entryList
                                                          .value[index]
                                                          .appStatus ==
                                                      "Y" ||
                                                            ...
                                                            children: [
                                                              ...
                                                              InkWell(
                                                                  ...
                                                                  onTap:
                                                                    ...
                                                                    setState(
                                                                        () {
                                                                      billGenerationBoqController.DeleteAlert(
                                                                          context,
                                                                          index);
                                                                    });
                                                                  }),
