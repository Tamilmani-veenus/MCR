...
class _AdvReq_voucher_NewState extends State<AdvReq_voucher_New> {
  ...
  void initState() {
    ...
    Future.delayed(duration, () async {
      if (advanceReqVoucherController_new.saveButton.value ==
      ...
      else if (advanceReqVoucherController_new.saveButton.value ==
          RequestConstant.RESUBMIT ||
          advanceReqVoucherController_new.saveButton.value ==
              RequestConstant.APPROVAL) {
        advanceReqVoucherController_new.editListApiDatas.forEach((
            element) async {
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            onTap: () async {
                              ...
                              else if (commonVoucherController.selectedAccId.value == 5){
                                showDialog(
                                    context: context,
                                    builder: (BuildContext context) {
                                      return Payfor_Alert();
