  ...
  void initState() {
    ...
    Future.delayed(duration, () async {
      ...
      if (dailyEntriesController.editcheck == 1) {
        if (dailyEntriesController.screenCheck == "PendingScreen") {
        ...
        dailyEntriesController.EditListResDatas.value.forEach((element) async {
          ...
          dailyEntriesController.Nmr_Rate.value == "N" ? "NMR" : "RATE";
        });
      }
      ...
      if (dailyEntriesController.entrycheck == 0) {
        ...
        dailyEntriesController.saveButton.value = RequestConstant.SUBMIT;
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            readOnly: true,
                            controller:
                            dailyEntriesController.autoYearWiseNoController,
                            ...
                            child: Card(
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  readOnly: true,
                                  controller:
                                  dailyEntriesController.AttendDateController,
                                  cursorColor: Colors.black,
                                  style: const TextStyle(color: Colors.black),
                                  decoration: const InputDecoration(
                                    contentPadding: EdgeInsets.zero,
                        ...
                        children: [
                          Expanded(
                            child: ElevatedButton(
                                style: ElevatedButton.styleFrom(backgroundColor: Setmybackground),
                                onPressed: () async {
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (dailyEntriesController.screenCheck ==
                                    ...
                                    // if (dailyEntriesController.gettingNetworkImages.length==0) {
                                    //   takeNetPicture();
                                    // } else {
                                    // takePicture();
                                    Navigator.push(
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                dailyEntriesController
                                    .readListdata.value[index].siteName,
                                style: TextStyle(
                                    color: Theme.of(context).primaryColor,
                                    fontWeight: FontWeight.bold),
                              ),
                          ...
                          children: <Widget>[
                              ...
                              child: RichText(
                                text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      ...
                                      TextSpan(
                                        text: dailyEntriesController.EntrySCreenNosControllers[index].text != "" && dailyEntriesController.EntrySCreenNosControllers[index].text != "0" && dailyEntriesController.EntrySCreenNosControllers[index].text != "0.0" ? "" : " *",
                                        style: TextStyle(
                                          color: dailyEntriesController.EntrySCreenNosControllers[index].text != "" && dailyEntriesController.EntrySCreenNosControllers[index].text != "0" && dailyEntriesController.EntrySCreenNosControllers[index].text != "0.0" ? Colors.white : Colors.red,
                                          fontSize: 12.0,
                                          fontWeight: FontWeight.bold,
                                        ),
                                      ),
                            ...
                            Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                      onTap: (){
                                        if(dailyEntriesController.EntrySCreenNosControllers[index].text != "" && dailyEntriesController.EntrySCreenNosControllers[index].text != "0" && dailyEntriesController.EntrySCreenNosControllers[index].text != "0.0"){
                                          return;
                                        } else {
                                          setState(() {
                                            dailyEntriesController.EntrySCreenNosControllers[index].text = "";
                            ...
                            Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                      onTap: (){
                                        if(dailyEntriesController.MrngOtHrsControllers[index].text != "" && dailyEntriesController.MrngOtHrsControllers[index].text != "0" && dailyEntriesController.MrngOtHrsControllers[index].text != "0.0"){
                                          return;
                                        } else {
                                          setState(() {
                                            dailyEntriesController.MrngOtHrsControllers[index].text = "";
                                            dailyEntriesController.clickEdit();
                                          });
                                        }
                                      },
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                      onTap: (){
                                        if(dailyEntriesController.EvgOtHrsControllers[index].text != "" && dailyEntriesController.EvgOtHrsControllers[index].text != "0" && dailyEntriesController.EvgOtHrsControllers[index].text != "0.0"){
                                          return;
                                        } else {
                                          setState(() {
                                            dailyEntriesController.EvgOtHrsControllers[index].text = "";
                                            dailyEntriesController.clickEdit();
                                          });
                                        }
                                      },
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    onTap: (){
                                      dailyEntriesController.RemarksControllers[index].text = "";
                                    },
                                    textAlign: TextAlign.center,
