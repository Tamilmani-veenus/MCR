                ...
                Expanded(
                  child: InkWell(
                    ...
                    setState(() {
                      ...
                      for(int i=0;i< dailyEntriesController.store_ShowList.length;i++){
                      dailyEntriesController.NosControllers[i].text='0';
                      dailyEntriesController.OtHrsController[i].text='0';
                      }
                    });
                    },
                  ),
