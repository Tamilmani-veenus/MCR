    ...
    Future.delayed(duration, () async {
      ...
      if (workOrderDirectController.saveButton.value == RequestConstant.RESUBMIT || workOrderDirectController.saveButton.value == RequestConstant.VERIFY || workOrderDirectController.saveButton.value == RequestConstant.APPROVAL) {
        workOrderDirectController.workOrderMasterList.forEach((element) {
          ...
          workOrderDirectController.termsConditionController.text = element.termsCondition.toString();
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          autovalidateMode: AutovalidateMode.always,
                          readOnly: true,
                          controller: workOrderDirectController.rebateAmount,
                          cursorColor: Colors.black,
                          style: const TextStyle(color: Colors.black),
                          decoration: const InputDecoration(
                            contentPadding: EdgeInsets.zero,
                            border: InputBorder.none,
                            labelText: "After Rebate Amt",
                            labelStyle: TextStyle(
                              color: Colors.grey,
                              fontSize: RequestConstant.Lable_Font_SIZE,
                            ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller:
                              workOrderDirectController.termsConditionController,
                  ...
                  Expanded(
                    child: TextButton(
                        onPressed: () async {
                          ...
                          workOrderDirectController.workOrdentryDateController.text =
                              currentDate;
