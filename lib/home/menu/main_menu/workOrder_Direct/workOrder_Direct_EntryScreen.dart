...
import 'package:mcr/home/menu/main_menu/workOrder_Direct/workOrder_Direct_Itemlist.dart';
...
class WorkOrderDirectEntryScreen extends StatefulWidget {
  const WorkOrderDirectEntryScreen({super.key});

  @override
  State<WorkOrderDirectEntryScreen> createState() => _WorkOrderDirectEntryScreenState();
}

class _WorkOrderDirectEntryScreenState extends State<WorkOrderDirectEntryScreen> {
  ...
  void initState() {
    ...
    Future.delayed(duration, () async {
      ...
      if (workOrderDirectController.saveButton.value == RequestConstant.RESUBMIT || workOrderDirectController.saveButton.value == RequestConstant.VERIFY || workOrderDirectController.saveButton.value == RequestConstant.APPROVAL) {
        workOrderDirectController.workOrderMasterList.forEach((element) {
          workOrderDirectController.workid = element.workOrderId!;
          ...
          subcontractorController.Subcontractorname.text = element.subconName.toString();
          ...
          workOrderDirectController.WorkOrdActiveTypeText.text = element.activeStatus == "A" ? "Active" : "Inactive";
          workOrderDirectController.PreparedByController.text = element.preparedByName.toString();
