...
class _Boq_Revised_EntryScreenState extends State<Boq_Revised_EntryScreen> {
    ...
    Future.delayed(duration, () async {
      ...
      if (boq_revised_controller.editCheck == 1) {
        ...
        boq_revised_controller.BoqRevised_EditListApiValue.value.forEach((element) {
          ...
          boq_revised_controller.boq_preparedbyController.text = element.preparedbyName;
        ...
        body: SingleChildScrollView(
          child: Stack(
            children: [
                  ...
                  Container(
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          readOnly: true,
                          controller: boq_revised_controller.boq_autoYearWiseNoController,
                        ...
                        child: Container(
                          ...
                          child: Card(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                readOnly: true,
                                controller: boq_revised_controller.boq_dateController,
                                cursorColor: Colors.black,
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          readOnly: true,
                          controller:
                              boq_revised_controller.boq_preparedbyController,
                          cursorColor: Colors.black,
                          style: TextStyle(color: Colors.black),
                          decoration: InputDecoration(
                            contentPadding: EdgeInsets.zero,
              ...
              Obx(() => Container(
                    child: Visibility(
                      visible: boq_revised_controller.Boqitem_itemview_GetDbList.value.isEmpty ? false : true,
                      child: Container(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: TextField(
                                    ...
                                    textAlign: TextAlign.center,
                                    controller: boq_revised_controller
  ...
  Future SubmitAlert(BuildContext context) async {
    ...
    if (await BaseUtitiles.checkNetworkAndShowLoader(context)) {
      await boq_revised_controller.SaveButton_BoqRevisedScreen(
        context,
        boq_revised_controller.reviseId != 0
...
///-------old code
                  ...
                  //             BaseUtitiles.showToast("Some field missing *");
                  //           } else {
                  //             boq_revised_controller.SaveButton_BoqRevisedScreen(context, boq_revised_controller.reviseId != 0 ? boq_revised_controller.reviseId : 0);
                  //           }
                  //           boq_revised_controller.buttonControl=0;
                    ...
                    child: TextButton(
                        onPressed: () {
                          setState(() {
                            ...
                            boq_revised_controller.Boqitem_itemview_GetDbList
                                .clear();
                            ...
                            siteController.Sitename.text =
                                RequestConstant.SELECT;
                            boq_revised_controller.boq_preparedbyController
                                .text = loginController.EmpName();
                            boq_revised_controller
                                    .boq_autoYearWiseNoController.text =
                                autoYearWiseNoController
                                    .BOQRevised_autoYrsWise.value;
