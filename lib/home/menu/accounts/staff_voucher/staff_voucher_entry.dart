...
//
//   @override
//   State<Staff_Voucher_EntryScreen> createState() => _Subcont_Nmr_EntryScreenState_Site();
// }
//
// class _Subcont_Nmr_EntryScreenState_Site extends State<Staff_Voucher_EntryScreen> {
//
//
...
//         staffVoucher_Controller.SaveButton.value=RequestConstant.UPDATE;
...
//           staffVoucher_Controller.Button.value=element.payType=="SP"?"List":"Update";
//         });
//
//       }
//       if(staffVoucher_Controller.itemcheck==0&& staffVoucher_Controller.Active==0){
//         staffVoucher_Controller.SaveButton.value=RequestConstant.SAVE;
//         staffVoucher_Controller.Button.value=RequestConstant.SAVE;
...
//                   ],
//                 ),
//                 child: Text("Payment Option",style: TextStyle(fontSize: 10),),
//               ),
//               Container(
//                 margin: EdgeInsets.only(top: 5),
//                 child: Row(
...
//                         height: BaseUtitiles.getheightofPercentage(context, 4),
//                         child: Text("Pay For *",style: TextStyle(fontSize: 13),),
//                       ),
//                     ),
//                     Expanded(
//                       flex: 1,
...
//                         height: BaseUtitiles.getheightofPercentage(context, 4),
//                         child: Text("Mode of Payment *",style: TextStyle(fontSize: 13),),
//                       ),
//                     ),
//
//                   ],
...
//                         staffVoucher_Controller.Button=RequestConstant.SAVE.obs;
//                       });
//                     },
//                   ),
//                   Container(
...
//                   ),
//                   onPressed: () async {
//                     if(staffVoucher_Controller.Button.value=="List"){
//                       Navigator.push(
//                         context,
//                         MaterialPageRoute(builder: (context) =>  Staff_Voucher_Activity(1)),
//                       );
//                     }
//                     else{
//                       if(staffController.selectedstaffId.value==0 ||commonVoucherController.AccountTypename.text == "--Select--"||commonVoucherController.Accountname.text=="--Select--"||commonVoucherController.Paymodename.text=="--Select--"||commonVoucherController.AccPayforname.text=="--Select--"||double.parse(staffVoucher_Controller.TotalAmount.text)==0.0){
...
//                     }
//                   },
//                   child: Text( staffVoucher_Controller.Button.value),
//                 ),
//               ),
//             ],
//           ),
...
class _Subcont_Nmr_EntryScreenState_Site
    ...
    Future.delayed(duration, () async {
      ...
      if (staffVoucher_Controller.editcheck == 1) {
        ...
        staffVoucher_Controller.Sitevoucher_EditListApiValue.forEach((element) {
          ...
          staffVoucher_Controller.Button.value =
              element.payType == "SP" ? "List" : "Re-Submit";
        });
      }
      if (staffVoucher_Controller.itemcheck == 0 && staffVoucher_Controller.Active == 0) {
            ...
            SingleChildScrollView(
              ...
              child: Column(
                children: [
                          ...
                          child: Card(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(
                                  top: 3, left: 10, bottom: 5),
                              child: TextFormField(
                                readOnly: staffVoucher_Controller.type.value ==
                                        "SiteWise Payment"
                                    ? true
                                    : false,
                                keyboardType: TextInputType.number,
                  ...
                  Visibility(
                    visible:
                        commonVoucherController.Paymodename.text == "BY CHEQUE"
                            ? true
                            : false,
                    child: Column(
                      children: [
                          ...
                          child: Card(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                  ...
                                  keyboardType: TextInputType.number,
                                  controller:
                                      staffVoucher_Controller.ChequeDate,
                                  cursorColor: Colors.black,
                                  style: TextStyle(color: Colors.black),
                                  decoration: InputDecoration(
                                    contentPadding: EdgeInsets.zero,
                                  ...
                                  onTap: () async {
                                    if (staffVoucher_Controller.editcheck ==
                                        1) {
                                    } else {
                                      var Entrydate = await showDatePicker(
                                          context: context,
                    ...
                    children: <Widget>[
                      Radio<String>(
                        ...
                        onChanged: (value) {
                          setState(() {
                            staffVoucher_Controller.type.value = value!;
                            staffVoucher_Controller.Button =
                        ...
                        child: Row(
                          ...
                          children: [
                            ElevatedButton(
                                ...
                                onPressed: () {
                                  if (staffController.selectedstaffId.value ==
                                      0) {
                                    BaseUtitiles.showToast(
        ...
        children: [
          ...
          Container(
            ...
            child: ListView.builder(
              ...
              itemCount: staffVoucher_Controller
  ...
  Future SubmitAlert(BuildContext context) async {
    ...
    return await showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('Alert!'),
        content: Text(staffVoucher_Controller.editcheck == 1
            ...
            child: IntrinsicHeight(
              child: Row(
                ...
                children: [
                  ...
                  //               await staffVoucher_Controller.SaveButtonSitevoucher_ItemlistScreen(context, staffVoucher_Controller.VocID != 0 ? staffVoucher_Controller.VocID : 0);
                  //               staffVoucher_Controller.buttonControl=0;
                  //             }
                  ...
                  Expanded(
                    child: TextButton(
                        onPressed: () async {
                          ...
                          staffVoucher_Controller.Sitevoucher_itemview_GetDbList
                              .clear();
                          // staffVoucher_Controller.TotalAmount.text="0.00";
                          staffVoucher_Controller.staffvocDate.text =
                              BaseUtitiles.initiateCurrentDateFormat();
