...
import 'package:mcr/home/menu/accounts/site_voucher/site_voucher_new/site_voucher_entry_new.dart';
        ...
        Obx(()=> Visibility(
          ...
          child: FloatingActionButton.extended(
            onPressed: () {
              ...
              siteVoucher_Controller.Active = 0;
              Navigator.push(context, MaterialPageRoute(builder: (context) => const SiteVoucher_EntryScreen()));
            },
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    siteVoucher_Controller.SiteVocEtyList.value[index].vocNo
                                        .toString(),
                                    style:
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Expanded(
                                    flex: 8,
                                    child: Text(
                                      siteVoucher_Controller.SiteVocEtyList.value[index].vocDate,
                                      style: TextStyle(
                                        color: Colors.black,
                                      ),
                                    )),
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Expanded(
                                    flex: 8,
                                    child: Text(
                                      siteVoucher_Controller.SiteVocEtyList.value[index].accName.toString(),
                                      style: const TextStyle(color: Colors.black),
                                    ),
                                ),
                              ],
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Expanded(
                                    flex: 8,
                                    child: Text(
                                      siteVoucher_Controller.SiteVocEtyList.value[index].accType.toString(),
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Expanded(
                                    flex: 4,
                                    child: Text(
                                      siteVoucher_Controller.SiteVocEtyList.value[index].vocAmt.toString(),
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: Text(
                                                              siteVoucher_Controller.SiteVocEtyList.value[index].vocNo.toString(),
                                                              style: TextStyle(
                                                                  fontWeight: FontWeight.bold,
                                                                  color: Theme.of(context).primaryColor),
                                                            ),
