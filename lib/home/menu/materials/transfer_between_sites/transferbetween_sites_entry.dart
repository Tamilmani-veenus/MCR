...
class _TransferBetweenSites_EntryState extends State<TransferBetweenSites_Entry> {
  ...
  void initState() {
    ...
    Future.delayed(duration,() async {
      transferBt_Site_Controller.buttonControl=0;
     await autoYearWiseNoController.TransferBetSite_AutoYearWise();
     await projectController.getProjectList(context, 0);
     transferBt_Site_Controller.saveButton.value="";
     if(transferBt_Site_Controller.editcheck==1){
       transferBt_Site_Controller.editListApiDatas.value.forEach((element) {
         transferBt_Site_Controller.saveButton.value=RequestConstant.RESUBMIT;
         transferBt_Site_Controller.transId=element.transferId;
         transferBt_Site_Controller.ButtonChanges(element.transferId);
         transferBt_Site_Controller.autoyrwiseText.text=element.transferNo.toString();
         transferBt_Site_Controller.entryDateText.text=element.transferDate.toString();
         projectController.projectname.text=element.frProject.toString();
         projectController.selectedProjectId.value=element.frProjectId;
         transferBt_Site_Controller.FromSitename.text=element.frSiteName.toString();
         transferBt_Site_Controller.from_selectedsiteId.value=element.frSiteId;
         ...
         transferBt_Site_Controller.radioValue=element.transType==0?"transfer_usage":"transfer";
         transferBt_Site_Controller.prearedbyText.text=element.preparedbyName;
       });
     }
      if(transferBt_Site_Controller.entrycheck==0){
        ...
        transferBt_Site_Controller.radioValue="transfer_usage";
        transferBt_Site_Controller.transId=0;
        projectController.projectname.text="--SELECT--";
        projectController.selectedProjectId=0.obs;
        transferBt_Site_Controller.FromSitename.text="--SELECT--";
        transferBt_Site_Controller.from_selectedsiteId.value=0;
        ...
        transferBt_Site_Controller.entrycheck=1;
      }
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onTap: () async {
                                        ...
                                        transferBt_Site_Controller.entryDateText.text =
                        ...
                        Container(
                          ...
                          child: Card(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                readOnly: true,
                                controller: transferBt_Site_Controller.FromSitename,
                                cursorColor: Colors.black,
                                style: TextStyle(color: Colors.black),
                                decoration: InputDecoration(
                                  contentPadding: EdgeInsets.zero,
                                ...
                                onTap: () async {
                                  await transferBt_Site_Controller.From_SiteName(context, transferBt_Site_Controller.getSiteDropdownvalue.value);
                                },
                                validator: (value) {
                                  if (value!.isEmpty) {
                                    return '\u26A0 Enter user name';
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                onTap: () async {
                                  ...
                                  await bottomsheetControllers.ToSiteName(context, siteController.getSiteDropdownvalue.value);
                                },
                                validator: (value) {
                                  if (value!.isEmpty) {
                                    return '\u26A0 Enter user name';
                              ...
                              Row(
                                  children: [
                                    Radio<String>(
                                      ...
                                      groupValue: transferBt_Site_Controller.radioValue,
                                      fillColor: MaterialStateColor.resolveWith((states) => Theme.of(context).primaryColor),
                                      onChanged: (value) {
                                        setState(() {
                                          transferBt_Site_Controller.radioValue = value.toString();
                                        });
                                      },
                                    ),
                            ...
                            children: [
                              ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    //   BaseUtitiles.showToast("Project Name is missing");
                                    // }
                                    // else if(transferBt_Site_Controller.from_selectedsiteId.value==0){
                                    //   BaseUtitiles.showToast("FromSite Name is missing");
                                    // }
                                    // else{
                                    await transferBt_Site_Controller.getItemList(projectController.selectedProjectId.value,transferBt_Site_Controller.from_selectedsiteId.value,0,"D");
                                    // showDialog(
                                    //     context: context,
                                    //     builder: (BuildContext context) {
                                    //       return AddItemSitePopup();
                                    //     });
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                ...
                children: <Widget>[
                    ...
                    child: InkWell(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color:  transferBt_Site_Controller.checkColor == 0 ? Colors.white : Theme.of(context).primaryColor ,
                        ),
                        alignment: Alignment.center,
                        child: Text("Reset",
                          style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: RequestConstant.Lable_Font_SIZE,
                              color:  transferBt_Site_Controller.checkColor == 0 ?  Theme.of(context).primaryColor : Colors.white ),
                        ),
                      ),
                      onTap: (){
                        setState(() {
                          transferBt_Site_Controller.checkColor = 1;
                          ResetAlert(context);
                        });
                      },
                    ),
                  ...
                  Expanded(
                    child: InkWell(
                      ...
                      onTap: () async {
                          transferBt_Site_Controller.checkColor = 0;
                                    ...
                                    children:<Widget> [
                                      ...
                                      Container(
                                        ...
                                        child: TextField(
                                          ...
                                          onTap: (){
                                            if(transferBt_Site_Controller.Itemlist_TransQty_ListController[index].text=="0"||transferBt_Site_Controller.Itemlist_TransQty_ListController[index].text=="0.0"){
  ...
  Future SubmitAlert(BuildContext context) async {
    ...
    return await showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('Alert!'),
        content: Text(transferBt_Site_Controller.editcheck == 1 ? 'Are you sure to Re-Submit?' :
                        ...
                        return TextButton(
                          onPressed:  () async {
                            ...
                            if (await BaseUtitiles.checkNetworkAndShowLoader(context)) {
                              await transferBt_Site_Controller.Save_EntryScreen(
                                  context, transferBt_Site_Controller.transId);
                            }
                          },
                          child: Text(
                            transferBt_Site_Controller.editcheck == 1
                                ? RequestConstant.RESUBMIT
                                : RequestConstant.SUBMIT,
                            style: TextStyle(
                              color: transferBt_Site_Controller.buttonControl == 0
...
///-----------old code-----
                  ...
                  //       onPressed: ()   {
                  //         setState(() {
                  //           if(transferBt_Site_Controller.buttonControl==0){
                  ...
                  //             transferBt_Site_Controller.buttonControl = 0;
                  //           }
                  //           else if (transferBt_Site_Controller.buttonControl == 1) {
                  //             transferBt_Site_Controller.buttonControl = 0;
                  ...
                  //       },
                  //       child: Text(
                  //           transferBt_Site_Controller.editcheck == 1 ? RequestConstant.RESUBMIT : RequestConstant.SUBMIT,
