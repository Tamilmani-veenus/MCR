                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Text(
                                              transferBt_Site_Controller.entryList.value[index].exdate.toString(),
                                              style: TextStyle(
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Expanded(
                                      flex: 8,
                                      child: Text(
                                        transferBt_Site_Controller.entryList.value[index].frProject.toString(),
                                        style: TextStyle(
                                          color: Colors.black,
                                        ),
                                      )),
                                  ...
                                  Expanded(
                                      ...
                                      child: Text(
                                        transferBt_Site_Controller
                                            .entryList.value[index].fromSite.toString(),
                                        style: TextStyle(
                                          color: Colors.black,),
                                      )),
                                ],
                                                        ...
                                                        Visibility(
                                                          ...
                                                          child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                ...
                                                                FocusScope.of(context).unfocus();
                                                                await transferBt_Site_Controller.EntryList_EditApi(transferBt_Site_Controller.entryList.value[index].transferId,context);
                                                              }),
                                                        ),
                                                        Container(
                                                            margin: EdgeInsets.only(
