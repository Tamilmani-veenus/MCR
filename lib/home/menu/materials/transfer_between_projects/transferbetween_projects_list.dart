...
class _TransferBtweenProjects_EntrylistState
    extends State<TransferBtweenProjects_Entrylist> {
  ...
  @override
  void initState() {
    if (transferBW_project_Controller.entrycheck == 2) {
    ...
    transferBW_project_Controller.TRPEntrylistFrDate.text =
        lastDayOfMonth.toString().substring(0, 10);
    transferBW_project_Controller.TRPEntrylistToDate.text =
    ...
    transferBW_project_Controller.TRPEtyList.value =
        transferBW_project_Controller.mainEntrylist.value;
    super.initState();
  }
                          ...
                          child: TextField(
                            ...
                            onChanged: (value) {
                              setState(() {
                                transferBW_project_Controller.TRPEtyList.value =
                                    BaseUtitiles
                                        .filterSearchResults_TransferbetweenProjects(
                                            value,
                                            transferBW_project_Controller
                                                .mainEntrylist);
                              });
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        ...
                                        child: Text(
                                          transferBW_project_Controller
                                              .TRPEtyList.value[index].frProject
                                              .toString(),
                                          style: TextStyle(
                                            color: Colors.black,
                                          ),
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        ...
                                        child: Text(
                                          transferBW_project_Controller
                                              .TRPEtyList.value[index].toProject
                                              .toString(),
                                          style: TextStyle(
                                            color: Colors.black,
                                          ),
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        ...
                                        child: Text(
                                          transferBW_project_Controller
                                              .TRPEtyList.value[index].fromSite
                                              .toString(),
                                          style: TextStyle(
                                            color: Colors.black,
                                          ),
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        ...
                                        child: Text(
                                          transferBW_project_Controller
                                              .TRPEtyList.value[index].entryTypeName
                                              .toString(),
                                          style: TextStyle(
                                            color: Colors.black,
                                          ),
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        ...
                                        child: Text(
                                          transferBW_project_Controller
                                              .TRPEtyList.value[index].preparedByName
                                              .toString(),
                                          style: TextStyle(color: Colors.black),
                                        )),
                                    Expanded(
                                        ...
                                        child: IconButton(
                                            onPressed: () {
                                              if(transferBW_project_Controller.TRPEtyList.value[index].ackStatus=="A"){
                                                BaseUtitiles.showToast("Transfer acknowledgement made..can't edit or delete");
                                              }
