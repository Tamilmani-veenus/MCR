...
class _Inward_ListScreenState extends State<Inward_ListScreen> {
  ...
  void initState() {
    ...
    if(inward_controller.entryvalue==2){
      inward_controller.entryvalue=0;
    }
    else if(inward_controller.entryvalue==0){
    ...
    // inward_controller.getInward_EntryList(context);
                            ...
                            child: Card(
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  onTap: () async {
                                    inward_controller.inwardEtyList.clear();
                      ...
                      child: Container(
                        ...
                        child:  Column(
                          children: [
                            ...
                            FutureBuilder(
                              future: inward_controller.getInward_EntryList(context),
                                  ...
                                  return Container(
                                    ...
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          return snapshot.data![index].supplier.toLowerCase().contains(searchString) ?
                                          Container(
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Row(
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    snapshot.data[index].inwDate.toString(),
                                                                    style: TextStyle(
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Text(
                                                            snapshot.data[index].inwardNo.toString(),
                                                    ...
                                                    Row(
                                                      children: <Widget>[
                                                        ...
                                                        Expanded(
                                                            flex: 8,
                                                            child: Text(
                                                              snapshot.data[index].purOrdNo.toString(),
                                                              style: TextStyle(
                                                                color: Colors.black,
                                                              ),
                                                            )),
                                                    ...
                                                    Row(
                                                      children: <Widget>[
                                                        ...
                                                        Expanded(
                                                            flex: 8,
                                                            child: Text(
                                                              snapshot.data[index].supplier.toString(),
                                                              style: TextStyle(
                                                                color: Colors.black,),
                                                            )),
                                                      ],
                                                    ...
                                                    Row(
                                                      children: <Widget>[
                                                        ...
                                                        Expanded(
                                                            flex: 4,
                                                            child: Text(
                                                              snapshot.data[index].siteName.toString(),
                                                        ...
                                                        Expanded(
                                                            ...
                                                            child: IconButton(
                                                                onPressed: () {
                                                                  inwardId = snapshot.data[index].inwardId;
                                                                  if (kDebugMode) {
                                                                    print("Inward Id:: $inwardId");
                                                                  }
                                                                              ...
                                                                              Visibility(
                                                                                ...
                                                                                child: InkWell(
                                                                                    ...
                                                                                    onTap: () async {
                                                                                      ...
                                                                                      FocusScope.of(context).unfocus();
                                                                                      await inward_controller.EntryList_EditApi( snapshot.data[index].inwardId, snapshot.data[index].inwType,context);
                                                                                      // Navigator.pop(context);
                                                                                    }),
                                                                              ),
                                                                              Container(
