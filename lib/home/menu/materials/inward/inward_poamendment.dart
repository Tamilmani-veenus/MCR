...
class _Inward_PoAmendmentState extends State<Inward_PoAmendment> {
          ...
          child:  Row(
            ...
            children: [
              InkWell(
                ...
                onTap: () async {
                  bool checkBox = false;
                  for (var item in inwardPending_Controller.PoAmdList.value) {
                  ...
                  if (checkBox) {
                    ...
                    BaseUtitiles.showToast("Please select the check box to approve");
                  }
                },
              ),
            ],
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Expanded(
                          flex: 6,
                          child: Text(inwardPending_Controller.PoAmdList.value[index].material.toString())),
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                          flex: 2,
                          child: Text(inwardPending_Controller.PoAmdList.value[index].scale.toString())),
                      Expanded(
                          flex: 2,
                          child: Text("Po Qty", style: TextStyle(fontWeight: FontWeight.bold),)),
                      Expanded(
                          flex: 2,
                          child: Text(inwardPending_Controller.PoAmdList.value[index].qty.toString()))
                    ],
                  ),
  ...
  Future SubmitAlert(BuildContext context) async {
    ...
    if (await BaseUtitiles.checkNetworkAndShowLoader(context)) {
      await inwardPending_Controller.PoAmendment_ApprovalButtonsave(context);
      Navigator.pop(context);
    }
                        },
