...
class _Consumption_ListState extends State<Consumption_List> {
  ...
  @override
  void initState() {
    if(consumption_controller.itemCheck==2){
      consumption_controller.itemCheck=0;
    }
    else if(consumption_controller.itemCheck==0){

    }
    else{
      consumption_controller.itemCheck=1;
    }
    ...
    consumption_controller.ConsumEntrylistFrDate.text = lastDayOfMonth.toString().substring(0, 10);
    consumption_controller.ConsumEntrylistToDate.text = currentDate.toString().substring(0, 10);
    consumption_controller.getConsum_EntryList();
    consumption_controller.ConsumEtyList.value = consumption_controller.mainEtyList.value;
    super.initState();
  }
              ...
              Obx(()=> Visibility(
                ...
                child: FloatingActionButton.extended(
                  onPressed: (){
                    consumption_controller.editCheck =0;
                    consumption_controller.itemCheck =0;
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Consumption_Entry()));
                  },
                    ...
                    Container(
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            readOnly: true,
                            controller: consumption_controller.ConsumEntrylistFrDate,
                            ...
                            onTap: () async {
                              ...
                              consumption_controller.ConsumEntrylistFrDate.text = Frdate.toString().substring(0, 10);
                            },
                            validator: (value) {
                    ...
                    Container(
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            readOnly: true,
                            controller: consumption_controller.ConsumEntrylistToDate,
                            cursorColor: Colors.black,
                            style: TextStyle(color: Colors.black),
                            decoration: InputDecoration(
                              contentPadding: EdgeInsets.zero,
                    ...
                    children: [
                      Container(
                        ...
                        child: TextField(
                          ...
                          onChanged: (value) {
                            setState(() {
                              consumption_controller.ConsumEtyList.value = BaseUtitiles.filterSearchResults_Consumption(value,consumption_controller.mainEtyList);
                            });
                          },
                        ),
                      ),
                              ...
                              Row(
                                ...
                                children: [
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Text(
                                              consumption_controller.ConsumEtyList.value[index].exdate.toString(),
                                              style: TextStyle(
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      consumption_controller.ConsumEtyList.value[index].expenseNo.toString(),
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Expanded(
                                      flex: 8,
                                      child: Text(
                                        consumption_controller.ConsumEtyList.value[index].entryType.toString(),
                                        style: TextStyle(
                                          color: Colors.black,
                                        ),
                                      )),
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Expanded(
                                      flex: 8,
                                      child: Text(
                                        consumption_controller.ConsumEtyList.value[index].project.toString(),
                                        style: TextStyle(
                                          color: Colors.black,),
                                      )),
                                ],
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Expanded(
                                      flex: 8,
                                      child: Text(
                                        consumption_controller.ConsumEtyList.value[index].site.toString(),
                                        style: TextStyle(
                                          color: Colors.black,),
                                      )),
                                ],
                                  ...
                                  Expanded(
                                      ...
                                      child: Text(
                                        consumption_controller
                                            .ConsumEtyList.value[index].preparedByName
                                            .toString(),
                                        style: TextStyle(color: Colors.black),
                                      )),
                                  Expanded(
                                                        ...
                                                        Visibility(
                                                          ...
                                                          child: InkWell(
                                                              ...
                                                              onTap: () {
                                                                ...
                                                                consumption_controller.getusageDetList.clear();
                                                                FocusScope.of(context).unfocus();
                                                                consumption_controller.ConsumEntryList_EditApi(consumption_controller.ConsumEtyList.value[index].expenseId,context);
                                                              }),
                                                        ),
                                                        Container(
                                                            margin: EdgeInsets.only(
                  ...
                  Expanded(
                    child: TextButton(
                        onPressed: () async {
                          consumption_controller.editCheck=0;
                          consumption_controller.itemCheck=0;
                          await consumption_controller.delete_Consum_itemlist_Table();
                          consumption_controller.Consum_itemview_GetDbList.value.clear();
                          await consumption_controller.Consum_EntryList_DeleteApi( consumption_controller.ConsumEtyList.value[index].expenseId, consumption_controller.ConsumEtyList.value[index].expenseNo);
                          consumption_controller.ConsumEtyList.removeAt(index);
