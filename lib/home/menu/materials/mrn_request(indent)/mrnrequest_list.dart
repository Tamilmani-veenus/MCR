...
class MRN_RequestIndent_Entrylist extends StatefulWidget {
  ...
  @override
  State<MRN_RequestIndent_Entrylist> createState() => _MRN_RequestIndent_EntrylistState();
}

class _MRN_RequestIndent_EntrylistState extends State<MRN_RequestIndent_Entrylist> {
          ...
          floatingActionButton: Obx(()=> Visibility(
            ...
            child: FloatingActionButton.extended(
              onPressed: (){
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => MRNRequest_Indent_Entry()));
              },
                      ...
                      Container(
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              readOnly: true,
                              controller: mrn_request_controller.MrnEntrylistFrDate,
                      ...
                      Container(
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              readOnly: true,
                              controller: mrn_request_controller.MrnEntrylistToDate,
                              cursorColor: Colors.black,
                              style: TextStyle(color: Colors.black),
              ...
              child: Container(
                ...
                child: Obx(
                  () => ListView.builder(
                      ...
                      itemCount: mrn_request_controller.MrnReqEtyList.value.length,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  mrn_request_controller
                                                      .MrnReqEtyList.value[index].reqOrdDate
                                                      .toString(),
                                                  style: TextStyle(
                                                      color: Theme.of(context).primaryColor,
                                                      fontWeight: FontWeight.bold),
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          mrn_request_controller
                                              .MrnReqEtyList.value[index].reqOrdNo
                                              .toString(),
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      Expanded(
                                          ...
                                          child: Text(
                                            mrn_request_controller
                                                .MrnReqEtyList.value[index].project
                                                .toString(),
                                            style: TextStyle(
                                                color: Colors.black,
                                              ),
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      Expanded(
                                          ...
                                          child: Text(
                                            mrn_request_controller
                                                .MrnReqEtyList.value[index].sitename
                                                .toString(),
                                            style: TextStyle(
                                              color: Colors.black,
                                            ),
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      Expanded(
                                          ...
                                          child: Text(
                                            mrn_request_controller
                                                .MrnReqEtyList.value[index].reqDueDate
                                                .toString(),
                                            style: TextStyle(
                                                color: Colors.black,),
                                          )),
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      Expanded(
                                          flex: 4,
                                          child: Text(
                                            mrn_request_controller.MrnReqEtyList.value[index].Preparedby.toString(),
                                            style: TextStyle(color: Colors.black),
                                          )),
                                      Expanded(
                                          flex: 1,
                                                          ...
                                                          children: [
                                                              ...
                                                              children: [
                                                                Expanded(
                                                                  child: Container(
                                                                    margin: EdgeInsets.only(right: 10),
                                                                    child: Text(
                                                                      mrn_request_controller.MrnReqEtyList.value[index].reqOrdNo.toString(),
                                                                      style: TextStyle(
                                                                          fontWeight: FontWeight.bold,
                                                                          color: Theme.of(context).primaryColor),
                                                                    ),
                                                            ...
                                                            Visibility(
                                                              ...
                                                              child: InkWell(
                                                                  ...
                                                                  onTap: () async {
                                                                    FocusScope.of(context).unfocus();
                                                                    await mrn_request_controller.MaterialIntentList_EditApi(mrn_request_controller.MrnReqEtyList[index].reqMasId, mrn_request_controller.MrnReqEtyList[index].projectid, mrn_request_controller.MrnReqEtyList[index].siteid, context,"Edit");
                                                                  }),
                                                            ),
                                                            Container(
                                                            ...
                                                            Visibility(
                                                              ...
                                                              child: InkWell(
                                                                  ...
                                                                  onTap: () async {
                                                                    Navigator.pop(context);
                                                                    mrn_request_controller.DeleteAlert(context, index);
                                                                  }),
                                                            ),
                                                            SizedBox(height: 20)
                                                          ],
