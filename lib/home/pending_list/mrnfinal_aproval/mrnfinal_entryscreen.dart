...
import '../mrnpre_aproval/mrnpreapr_itemlist.dart';
...
class _MrnfinalEntryScreenState extends State<MrnfinalEntryScreen> {
  ...
  Future<void> getPreviousValue() async {
    int i=0;
    mrnFinalApprovalController.MaterialFinalAppr_itemview_GetDbList.forEach((element) {
      ...
      mrnFinalApprovalController.ApprQty_ListController[i].text = element.appqty.toString();
      // mrnFinalApprovalController.Approval_ListController[i].text= "PO";
      mrnFinalApprovalController.approvalType = element.apptype.toString() == "P" ? "PO" :
      element.apptype.toString() == "H" ? "Cash PO" : element.apptype.toString() == "O" ? "Rental WorkOrder" :
      element.apptype.toString() == "I" ? "Cash Inward" : element.apptype.toString() == "T" ? "Transfer" :
      element.apptype.toString() == "C" ? "Cancel" : element.apptype.toString() == "W" ? "Pending" : "";
      mrnFinalApprovalController.Approval_ListController[i].text = element.apptype.toString() == "P" ? "PO" :
      element.apptype.toString() == "H" ? "Cash PO" : element.apptype.toString() == "O" ? "Rental WorkOrder" :
      element.apptype.toString() == "I" ? "Cash Inward" : element.apptype.toString() == "T" ? "Transfer" :
      element.apptype.toString() == "C" ? "Cancel" : element.apptype.toString() == "W" ? "Pending" : "";
      mrnFinalApprovalController.TransfrProject_ListController[i].text = element.tranfromprjname.toString();
      mrnFinalApprovalController.projectId[i].text = element.tranfromprjid.toString();
      mrnFinalApprovalController.Description_ListController[i].text = element.desc.toString();
      mrnFinalApprovalController.Remarks_ListController[i].text = element.remarks.toString();
      i++;
    });
  }
  ...
  @override
  void initState() {
    if(mrnFinalApprovalController.entrycheck==0){
      pendingListController.mrnfinalapprovallist.forEach((element) {
        ...
        mrnFinalApprovalController.ApprovalNoText.text=pendingListController.mrn_preapproval_autoYrsWise.value;
        ...
        mrnFinalApprovalController.ReqremarksText.text = element.req_remarks.toString();
        mrnFinalApprovalController.ApprovalremarksText.text = "";
      });

      int i=0;
      mrnFinalApprovalController.MaterialFinalAppr_itemview_GetDbList.forEach((element) async {
        mrnFinalApprovalController.itemlist_textControllersInitiate();
        mrnFinalApprovalController.BalQty_ListController[i].text = element.balqty.toString();
        mrnFinalApprovalController.ReqQty_ListController[i].text = element.reqqty.toString();
        mrnFinalApprovalController.ApprQty_ListController[i].text = element.appqty.toString();
      ...
      //   await mrnFinalApprovalController.getFinalApp_MaterialsItemlist_TableDatas();
      ...
      //   element.apptype.toString() == "I" ? "Cash Inward" : element.apptype.toString() == "T" ? "Transfer" :
      //   element.apptype.toString() == "C" ? "Cancel" : element.apptype.toString() == "W" ? "Pending" : "";
      //   // mrnFinalApprovalController.Approval_ListController[i].text= element.type.toString()=="P"?"PO" :
      //   // element.type.toString() == "H" ? "Cash PO" : element.type.toString() == "O" ? "Rental WorkOrder" :
      //   // element.type.toString() == "I" ? "Cash Inward" : element.type.toString() == "T" ? "Transfer" :
      //   // element.type.toString() == "C" ? "Cancel" : "" ;
  ...
  Widget build(BuildContext context) {
    ...
    //                       margin: EdgeInsets.only(left: 20,top: 10),
    //                       height: BaseUtitiles.getheightofPercentage(context, 4),
    //                       child: Text("Project Name ",style: TextStyle(fontSize: 13),),
    //                     ),
    //                   ),
    //                   Expanded(
    //                     flex: 1,
    ...
    //                       margin: EdgeInsets.only(left: 20,top: 10),
    //                       height: BaseUtitiles.getheightofPercentage(context, 4),
    //                       child: Text("Site Name ",style: TextStyle(fontSize: 13),),
    //                     ),
    //                   ),
    //                   Expanded(
    //                     flex: 1,
    ...
    //                       margin: EdgeInsets.only(left: 20,top: 10),
    //                       height: BaseUtitiles.getheightofPercentage(context, 4),
    //                       child: Text("Request Remarks",style: TextStyle(fontSize: 13),),
    //                     ),
    //                   ),
    //                   Expanded(
    //                     flex: 1,
    ...
    //                       margin: EdgeInsets.only(left: 20,top: 10),
    //                       height: BaseUtitiles.getheightofPercentage(context, 4),
    //                       child: Text("Approval Remarks",style: TextStyle(fontSize: 13),),
    //                     ),
    //                   ),
    //                   Expanded(
    //                     flex: 1,
    ...
    //                       margin: EdgeInsets.only(left: 20,top: 10),
    //                       height: BaseUtitiles.getheightofPercentage(context, 4),
    //                       child: Text("PreApproved By",style: TextStyle(fontSize: 13),),
    //                     ),
    //                   ),
    //                   Expanded(
    //                     flex: 1,
    ...
    //                       margin: EdgeInsets.only(left: 20,top: 10),
    //                       height: BaseUtitiles.getheightofPercentage(context, 4),
    //                       child: Text("Verified By",style: TextStyle(fontSize: 13),),
    //                     ),
    //                   ),
    //                   Expanded(
    //                     flex: 1,
    ...
    //                       margin: EdgeInsets.only(left: 20,top: 10),
    //                       height: BaseUtitiles.getheightofPercentage(context, 4),
    //                       child: Text("Prepared By",style: TextStyle(fontSize: 13),),
    //                     ),
    //                   ),
    //                   Expanded(
    //                     flex: 1,
