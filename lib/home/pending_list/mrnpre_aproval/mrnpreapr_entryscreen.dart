...
class MrnPreApprovalEntryScreen extends StatefulWidget {
  const MrnPreApprovalEntryScreen({Key? key}) : super(key: key);
...
class _MrnPreApprovalEntryScreenState extends State<MrnPreApprovalEntryScreen> {
  ...
  void initState()  {
    ...
    if(mrnPreApprovalController.entrycheck==0){
      pendingListController.mrnPreapprovallist.forEach((element) {
        ...
        mrnPreApprovalController.mrnpre_ReqremarksText.text = element.req_remarks.toString();
      });
      int i=0;
      ...
      //  // mrnPreApprovalController.mrnpre_Approval_ListController[i].text=element.appType == "PO" ? "Civil Items" : element.appType == "HI" ? "HSE Items" : element.appType=="PI" ? "PEB Items": element.appType=="MI" ? "MEB Items" : element.appType=="II" ? "Interior Items" : "";
      ...
      //  // mrnPreApprovalController.mrnpre_projectId[i].text=element.refProjectid.toString();
      //  mrnPreApprovalController.mrnpre_Description_ListController[i].text=element.description.toString();
      //  mrnPreApprovalController.mrnpre_Remarks_ListController[i].text=element.remarks.toString();
      //   i++;
      // });

      mrnPreApprovalController.MaterialAppr_itemview_GetDbList.forEach((element) {
        mrnPreApprovalController.itemlist_textControllersInitiate();
        mrnPreApprovalController.mrnpre_BalQty_ListController[i].text=element.balqty.toString();
        mrnPreApprovalController.mrnpre_ReqQty_ListController[i].text=element.reqqty.toString();
        mrnPreApprovalController.mrnpre_ApprQty_ListController[i].text=element.appqty.toString();
        mrnPreApprovalController.mrnpre_Approval_ListController[i].text="PO";
        mrnPreApprovalController.approvalType = "PO";
        // mrnPreApprovalController.mrnpre_Approval_ListController[i].text=element.appType == "PO" ? "Civil Items" : element.appType == "HI" ? "HSE Items" : element.appType=="PI" ? "PEB Items": element.appType=="MI" ? "MEB Items" : element.appType=="II" ? "Interior Items" : "";
        mrnPreApprovalController.mrnpre_TransfrProject_ListController[i].text="--Select--";
        mrnPreApprovalController.mrnpre_projectId[i].text="0";
        // mrnPreApprovalController.mrnpre_projectId[i].text=element.refProjectid.toString();
        mrnPreApprovalController.mrnpre_Description_ListController[i].text=element.desc.toString();
        mrnPreApprovalController.mrnpre_Remarks_ListController[i].text=element.remarks.toString();
        i++;
      });
