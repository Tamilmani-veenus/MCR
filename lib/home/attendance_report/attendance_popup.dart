          ...
          children: <Widget>[
            Container(
              ...
              alignment: Alignment.center,
                ...
                child: Text(attendNo,style: TextStyle(color: Colors.white))
            ),
        Container(
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                          ...
                          children: <Widget>[
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child: Text("Nos",style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                              ),
                            ),
                            Expanded(
                              flex:2,
                            ...
                            Expanded(
                              ...
                              child: Container(
                                margin: EdgeInsets.only(top: 3),
                                child: Text("Extras",style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                              ),
                            ),
                            Expanded(
                              flex:2,
                      ...
                      Container(
                        margin: EdgeInsets.only(top: 3,  left: 5, right: 5, bottom: 5),
                        child: Row(
                          children: <Widget>[
                            Expanded(
                              flex:3,
                              child: Container(
                                margin: EdgeInsets.only(top: 3),
                                child: Text("Mrng OT Hrs",style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                              ),
                            ),
                            Expanded(
                              flex:2,
                            ...
                            Expanded(
                              ...
                              child: Container(
                                margin: EdgeInsets.only(top: 3),
                                child: Text("Mrng OT Amt",style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                              ),
                            ),
                            Expanded(
                              flex:2,
                        ...
                        child: Row(
                          children: <Widget>[
                            Expanded(
                              ...
                              child: Container(
                                margin: EdgeInsets.only(top: 3),
                                child: Text("Eve OT Hrs",style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                              ),
                            ),
                            Expanded(
                              flex:2,
                            ...
                            Expanded(
                              ...
                              child: Container(
                                margin: EdgeInsets.only(top: 3),
                                child: Text("Eve OT Amt",style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                              ),
                            ),
                            Expanded(
                              flex:2,
                        ...
                        child: Row(
                          children: <Widget>[
                            Expanded(
                              ...
                              child: Container(
                                margin: EdgeInsets.only(top: 3),
                                child: Text("ExtraAmt",style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                              ),
                            ),
                            Expanded(
                              flex:2,
                            ...
                            Expanded(
                              ...
                              child: Container(
                                margin: EdgeInsets.only(top: 3),
                                child: Text("Net Amt",style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                              ),
                            ),
                            Expanded(
                              flex:2,
