                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        onTap: () async {
                          ...
                          bottomsheetControllers.CompanyName(context, companyController.getdropDownvalue.value,type: "mrnReqTracker");
                        },
                      ),
                    ),
                  ),
                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        onTap: () async {
                          await companyController.getProjectList_CompanyWise(context, 0,type: "mrnReqTracker");
                          bottomsheetControllers.projectNameReport(context, companyController.getdropDownvalue_Companywise.value,type: "mrnReqTracker");
                        },
                      ),
                    ),
                  ),
                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        onTap: () async {
                          await reportsController.getSiteReportList(context,
              ...
              onTap: () async {
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return mrnReqTrackerPopup(list: siteController.mrnReqTrackerListValue[index]);
                    });
              },
              child: Container(
                            ...
                            children: <Widget>[
                              Row(
                                children: [
                                  ...
                                  Text(
                                    siteController.mrnReqTrackerListValue.value[index].reqOrdDate??"-",
                                    style: TextStyle(color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold),
                                  ),
                                ],
                              ),
                              Text(siteController.mrnReqTrackerListValue.value[index].reqOrdNo??"-",style: TextStyle(color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold),),
                            ],
                          ),
                        ),
                        SizedBox(height: 5,),
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              flex: 4,
                              child: Text(
                                siteController.mrnReqTrackerListValue.value[index].materialName??"-",style: const TextStyle(color: Colors.black),
                              ),
                            ),
                          ],
                        ),
