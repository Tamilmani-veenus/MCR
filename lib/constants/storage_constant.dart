import 'dart:convert';
import 'package:mcr/models/punch_in_payload.dart';
import 'package:mcr/models/punch_out_payload.dart';
import 'package:mcr/models/site_location_response.dart';
...
class ServiceLocalDatabaseService {
  ...
  static Future<void> saveLoginDetails(List<LoginDetailsPayload> newDetails,String key) async {
    ...
    printToLog("Saved values :: $loginDetailsJson");
  ...
  static Future<List<LoginDetailsPayload>> getLoginDetails(String key) async {
    ...
    printToLog("Login details :: $loginDetailsJson");
  ...
  static Future<List<PunchInPayload>> getPunchInDetails(String key) async {
    ...
    printToLog("Getting punch in details from local :: $punchInJson");
  ...
  static Future<List<PunchOutPayload>> getPunchOutDetails(String key) async {
    ...
    printToLog("Getting punch out details from local :: $punchOutJson");
