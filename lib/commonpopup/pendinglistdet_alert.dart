...
class PendingListDet_PreApproval extends StatefulWidget {
  const PendingListDet_PreApproval({Key? key, required this.list, required this.ReqNo, required this.ProjectName}) : super(key: key);
  final List list;
  final String ReqNo;
  final String ProjectName;
                    ...
                    children: [
                              ...
                              child: InkWell(
                                ...
                                onTap: (){
                                  pendingListController.poapprovalSupplierlist(context,
                                    ...
                                    pendingListController.onclickPendingListDet[index].scale.toString(),
                                  );
                                },
                              ))
                        ],
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                              flex: 4,
                              child: Text( pendingListController.onclickPendingListDet[index].PORate.toString())),
                          Expanded(
                              flex: 2,
                              child: Text("Scale" + ":  ",
                                style: TextStyle(fontWeight: FontWeight.bold),
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                              flex: 4,
                              child: Text( pendingListController.onclickPendingListDet[index].PoAmt.toString())),
                          Expanded(
                            flex: 2,
                            child: Text("GST Per:" ,
                              style: TextStyle(fontWeight: FontWeight.bold),
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                                  flex: 6,
                                  child: Text( pendingListController.onclickPendingListDet[index].NetAmt.toString()))
...
class PendingList_TransferPending_Popup extends StatefulWidget {
  const PendingList_TransferPending_Popup({Key? key, required this.list,required this.ReqNo}) : super(key: key);
  final List list;
  final String ReqNo;
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(
                            flex: 2,
                            child: Text("From Project:" ,
                              style: TextStyle(fontWeight: FontWeight.bold),
                            ),
                          ),
                          Expanded(
                              flex: 4,
                              child: Text( pendingListController.onclickPendingListDet[index].frProjectName.toString())),
                        ],
                      ),
