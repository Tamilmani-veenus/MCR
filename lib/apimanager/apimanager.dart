...
class ApiManager{
  ...
  static Future<dynamic> postAPICall(String url, String param) async {
    ...
    try {
      ...
      final response =  await client.post(uri, headers: RequestConstant.headers, body: param);
  ...
  static Future<dynamic> postCall(String url) async {
    ...
    try {
      ...
      final response =  await client.post(uri,
          headers: RequestConstant.headers);
      responseJson = _response(response);
    } on SocketException {
      throw FetchDataException('No Internet connection');
    }
  ...
  static Future<dynamic> putUpdateAPIButton(String url, String param) async {
    ...
    try {
      var uri = Uri.parse(url);
      final response =  await client.put(uri, headers: RequestConstant.headers, body: param);
      responseJson = _response(response);
    } on SocketException {
      throw FetchDataException('No Internet connection');
    }
