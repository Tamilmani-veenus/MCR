                ...
                itemBuilder: (context, index) {
                  return Column(
                    children: [
                      ...
                      InkWell(
                          onTap: () async {
                            await pendingListController.getSubcontractor_ExpensesList(
                                loginController.UserId(),
                                loginController.UserType(),
                                pendingListController.pendingList_datas.value[index].entrytype!, context);
                          },
                          child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Text(pendingListController.pendingList_datas.value[index].entrytype!),
                                  ),
