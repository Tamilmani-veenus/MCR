...
class MaterialController extends GetxController {
  ...
  Future getmaterialheadList(BuildContext context) async {
    materialheadListDropdown.value = await CommonProvider.materialWise_sub_HeadDropdown();
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return MaterialHeadShowPopup(list:materialheadListDropdown.value);
        });
  }
